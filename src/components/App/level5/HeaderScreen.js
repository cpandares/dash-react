      ...
      <ul className="navbar-nav ml-auto">
          ...
          <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a className="dropdown-item d-flex align-items-center" href="#">
              <div className="dropdown-list-image mr-3">
                <img className="rounded-circle" src="Logo.png" style= {{maxWidth: "60px"}} alt="" />
            ...
            <a className="dropdown-item align-items-center" href="#">
              <div className="mb-3">
                ...
                <div className="progress" style= {{height: "12px"}}>
                  <div className="progress-bar bg-success" role="progressbar" style= {{maxWidth: "50px"}} aria-valuenow="50"
        ...
        <li className="nav-item dropdown no-arrow">
          <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <img className="img-profile" src="../assets/Logo.png" style= {{width: "100%"}} />
