        ...
        <div>
            <ul className="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li className="nav-item active">
                    ...
                    <span style={{ color:"white" , fontFamily: 'serif' }}>Dashboard Supervisor </span></a>
                </li>
            ...
            <li className="nav-item">
                <Link to = "/" className="nav-link" >
                    ...
                    <span style={{ color:"white" , fontFamily: 'serif' }}>Home</span>
                </Link>
            </li>
            ...
            <li className="nav-item">
                <Link className="nav-link" to="/panel/legal" >
